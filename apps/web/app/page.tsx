    ...
    <main className="min-h-screen bg-slate-100 px-4 py-10 sm:px-6">
      <div className="mx-auto max-w-4xl">
        <div className="mb-7">
          ...
          <div className="mt-2 flex flex-wrap items-center justify-between gap-3"><p className="text-slate-600">Enter the employee details and assign their system access role.</p><Link href="/login" className="text-sm font-semibold text-blue-700 hover:text-blue-800">User sign in</Link></div>
        </div>
