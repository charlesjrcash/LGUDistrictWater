...
export default function BillingCyclesPage() {
  ...
  const [editingBillingCycleId, setEditingBillingCycleId] =
  ...
  function handleEditBillingCycle(billingCycle: BillingCycle) {
    ...
    setForm({
      ...
      number_of_days: billingCycle.number_of_days === null
        ? ""
  ...
  async function handleSaveBillingCycle(
    ...
    try {
      ...
      const response = await fetch("/api/billing-cycles", {
        ...
        body: JSON.stringify({
          ...(isEditing
            ? { billing_cycle_id: editingBillingCycleId }
            : {}),
              ...
              <table className="w-full text-left text-sm">
                <thead className="bg-gray-50 text-xs uppercase tracking-wide text-gray-500">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-right font-medium">Number of Days</th>
                  ...
                  {filteredBillingCycles.map((billingCycle) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span className={billingCycle.is_active
