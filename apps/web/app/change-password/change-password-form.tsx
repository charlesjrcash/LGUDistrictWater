...
export default function ChangePasswordForm({ recovery = false }: { recovery?: boolean }) {
...
async function handleSubmit(event: FormEvent<HTMLFormElement>) {
  ...
  try {
    ...
    setStatus({
      type: "success",
      message: recovery ? "Password reset successfully! Redirecting you to sign in..." : "Password changed successfully! Redirecting you to sign in...",
    });
    form.reset();
