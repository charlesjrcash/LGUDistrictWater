  ...
  return (
    <form onSubmit={handleSubmit} className={styles.form}>
      <div className={styles.formHeading}>
        ...
        <p>Use your registered Google account or temporary credentials.</p>
      </div>
      <a className={styles.googleButton} href="/api/auth/google/start">
        <svg aria-hidden="true" viewBox="0 0 24 24">
          ...
          <path
            fill="#34A853"
            d="M12 22c2.7 0 4.97-.9 6.63-2.42l-3.24-2.53c-.9.6-2.05.96-3.39.96-2.6 0-4.81-1.76-5.6-4.13H3.06v2.61A10 10 0 0 0 12 22Z"
          />
          <path
            fill="#FBBC05"
            d="M6.4 13.88A6 6 0 0 1 6.08 12c0-.65.11-1.29.32-1.88V7.51H3.06A10 10 0 0 0 2 12c0 1.61.39 3.14 1.06 4.49l3.34-2.61Z"
          />
          <path
            fill="#EA4335"
            d="M12 5.99c1.47 0 2.79.5 3.83 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.94 5.51l3.34 2.61C7.19 7.75 9.4 5.99 12 5.99Z"
          />
        </svg>
      ...
      <button type="submit" disabled={submitting}>
        {submitting ? (
          <>
            <i className={styles.spinner} /> Signing in...
          </>
        ) : (
          <>
            Sign in <span>→</span>
