...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return <><SiteHeader /><main className={styles.page}><section className={styles.intro}><div className={styles.introContent}><WaterLogo /></div><div className={styles.waveOne}/><div className={styles.waveTwo}/><div className={styles.waveThree}/></section><section className={styles.formPanel}><LoginForm initialError={error} /></section></main></>;
}
