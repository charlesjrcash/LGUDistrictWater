...
export function AccountDetails({
  ...
  const accountFields = [
    ...
    ["Service Type", account.serviceType || "â€”"],
    ["Reading Route", account.readingRoute || "â€”"],
    ["Date Connected", formatDate(account.dateConnected, true)],
    ["Service Address", account.serviceAddress || "â€”"],
    ["Created At", formatDate(account.createdAt, true)],
    [
      "Updated At",
      account.updatedAt ? formatDate(account.updatedAt, true) : "â€”",
    ],
  ];
  return (
    <TransactionShell active="service-accounts">
