...
export function CreateAccountForm({
  ...
  const [serviceTypes, setServiceTypes] = useState<ReferenceOption[]>([]);
  const [routes, setRoutes] = useState<ReferenceOption[]>([]);
  ...
  const [dateConnected, setDateConnected] = useState("");
    ...
    async function load() {
      try {
        ...
        if (!cancelled) {
          ...
          setServiceTypes(optionsBody.data.serviceTypes);
          setRoutes(optionsBody.data.readingRoutes);
          setAddress(contextBody.data.customer.address || "");
        }
      } catch (loadError) {
        if (!cancelled)
          setError(
        ...
        <div className={styles.headingRow}>
          <div>
            ...
            <p className={styles.subtitle}>
              Create a service account from this approved application.
            </p>
          </div>
        </div>
        <form
            ...
            context && (
              <>
                <section className={styles.section}>
                  <div className={styles.cardHeading}>
                    <div>
                      ...
                      <p className={styles.sectionDescription}>
                        Application and customer are linked automatically.
                      </p>
                    </div>
                  ...
                  {!approved && (
                    <div className={styles.notice}>
                      Only approved applications can create a service account.
                    </div>
                  )}
                ...
                <section className={styles.section}>
                  ...
                  <p className={styles.sectionDescription}>
                    Control number is generated and the initial connection
                    status is Active.
                  </p>
                  <div className={styles.fieldGrid}>
                    ...
                    <Select
                      ...
                      onChange={setConnectionTypeCode}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={dateConnected}
                        onChange={(event) =>
                          setDateConnected(event.target.value)
                        }
                      />
